	...
	<div class="page-wrapper">
		...
		<aside class="menu-sidebar d-none d-lg-block">
			<div class="logo">
				...
				<img src="${pageContext.request.contextPath}/belongings/images/icon/logo.png" alt="Cool Admin" />
				</a>
			</div>
                ...
                <div class="login-wrap">
                    <div class="login-content">
                        <div class="login-logo">
                            <h2 class="title-1 m-b-25">Edit Member</h2>
                        </div>
                        <div class="login-form">
                            <form action="${pageContext.request.contextPath}/Admin/Member/Update" method="post" >
                            <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
                            <div class="form-group">
                                    <label>Member ID</label>
                                    <input class="au-input au-input--full" type="text" name="id" readonly="readonly" value="${modeldata.get(0).id}" >
                                </div>
                                <div class="form-group">
                                    <label>Name</label>
                                    <input class="au-input au-input--full" type="text" name="name" placeholder="Name" value="${modeldata.get(0).name}">
                                </div>
                                 <div class="form-group">
                                    <label>Phone</label>
                                    <input class="au-input au-input--full" type="text" name="phone" placeholder="Phone" value="${modeldata.get(0).phone}">
                                </div>
                                <div class="form-group">
                                    <label>Address</label>
                                    <input class="au-input au-input--full" type="text" name="address" placeholder="Address" value="${modeldata.get(0).address}">
                                </div>
                                <button class="au-btn au-btn--block au-btn--green m-b-20" type="submit">Update Member</button>
