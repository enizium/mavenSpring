					...
					<ul class="navbar-mobile__list list-unstyled">
						...
						<li class="has-sub"><a class="js-arrow" href="#"> <i
							...
							<ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
								<li><a
									href="${pageContext.request.contextPath}/Admin/Member/Add">Add
										Member</a></li>
								<li><a
									href="${pageContext.request.contextPath}/Admin/News/AddNews">Display</a>
								</li>
				...
				<nav class="navbar-sidebar">
					<ul class="list-unstyled navbar__list">
							...
							<ul class="list-unstyled navbar__sub-list js-sub-list">
								<li><a
									href="${pageContext.request.contextPath}/Admin/Member/Add">Add
										Member</a></li>
								<li><a
									href="${pageContext.request.contextPath}/Admin/Member/Display">Display</a>
								</li>
						...
						<i class="fas fa-copy"></i>News
							...
							<ul class="list-unstyled navbar__sub-list js-sub-list">
								<li><a href="${pageContext.request.contextPath}/Admin/News/AddNews">Add News</a></li>							
							</ul></li>
							...
							<div class="header-button">
										...
										<div class="mess-dropdown js-dropdown">
											...
											<div class="mess__item">
												<div class="image img-cir img-40">
													<img src="${pageContext.request}images/icon/avatar-06.jpg"
														alt="Michelle Moreno" />
												</div>
												<div class="content">
								...
								<div class="account-wrap">
									<div class="account-item clearfix js-item-menu">
										<div class="image">
											<img
												src="${pageContext.request.contextPath}/belongings/images/icon/avatar-01.jpg"
												alt="John Doe" />
										</div>
										<div class="content">
			...
			<div class="main-content">
				<div class="section__content section__content--p30">
					<div class="container-fluid">
						...
						<div class="row">
							<div class="col-lg-12">
								<h2 class="title-1 m-b-25">List of Member</h2>
										...
										<% int i = 1; %>
											<c:forEach items="${memberdata}" var="memberdata">
												<tr>
													...
													<td><a  class="btn btn-secondary btn-block" href="${pageContext.request.contextPath}/Admin/Member/Edit/${memberdata.id}">EDIT</a></td>
													<td><a  class="btn btn-secondary btn-block" href="${pageContext.request.contextPath}/Admin/Member/Delete/${memberdata.id}">DELETE</a></td>
