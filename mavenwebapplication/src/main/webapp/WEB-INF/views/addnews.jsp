					...
					<div class="login-wrap">
						<div class="login-content">
							<div class="login-logo">
								<h2 class="title-1 m-b-25">Add News</h2>
							</div>
							<div class="login-form">
								<form
									action="${pageContext.request.contextPath}/Admin/News/AddNews?${_csrf.parameterName}=${_csrf.token}"
									method="post" enctype="multipart/form-data">

									<div class="form-group">
										<label>Title</label> <input class="au-input au-input--full"
											type="text" name="title" placeholder="Title">
									</div>
									<div class="form-group">
										<label>Author</label> <input class="au-input au-input--full"
											type="text" name="author" placeholder="Author">
									</div>
									<div class="form-group">
										<label>Article</label>
										<textarea class="au-input au-input--full" rows="4" cols="50"
											name="article" placeholder="Article"></textarea>
									</div>
									...
									<div class="form-group">
										<label>Image</label> <input type="file"
											class="au-input au-input--full" name="image">
									</div>
									<div class="form-group">
										<label>Date</label> <input type="date"
											class="au-input au-input--full" name="date">
									</div>
