...
<body data-spy="scroll" data-target=".navbar-collapse">
								...
								<div class="container-fluid">
									...
									<div class="collapse navbar-collapse"
										...
										<ul class="nav navbar-nav navbar-right">
											...
											<li><a href="#contact">Add Member</a></li>
							...
							<div class="row">
								...
								<div class="col-sm-6">
									<div
										...
										<form action="addmember" method="post" formid">
											<div
	...
	<script
		src="${pageContext.request.contextPath}/resources/js/vendor/jquery-1.11.2.min.js"></script>
	<script
	...
	<!--slick slide js -->
	<script
		src="${pageContext.request.contextPath}/resources/css/slick/slick.js"></script>
	<script
		src="${pageContext.request.contextPath}/resources/css/slick/slick.min.js"></script>
